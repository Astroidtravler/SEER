...
def get_args():
    ...
    parser.add_argument('--mcts_objective_mode', type=str, default='graph_td', choices=['seer', 'graph_td', 'conservative', 'parametric'])
    ...
    parser.add_argument('--mcts_calibration_mode', type=str, default='heuristic', choices=['heuristic', 'ece_temp'])
    parser.add_argument('--mcts_ece_bins', type=int, default=10)
    parser.add_argument('--mcts_calibration_min_t', type=float, default=0.7)
    parser.add_argument('--mcts_calibration_max_t', type=float, default=3.0)
